...
def ask():
    while True:
        try:
            sent = sock.sendto('battery?'.encode(
...
def down():
    try:
        sent = sock.sendto('down 20'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
# 前に進む(20cm)
...
def forward():
    try:
        sent = sock.sendto('forward 20'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
# 後に進む(20cm)
...
def back():
    try:
        sent = sock.sendto('back 20'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
# 右に進む(20cm)
...
def right():
    try:
        sent = sock.sendto('right 20'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
# 左に進む(20cm)
...
def left():
    try:
        sent = sock.sendto('left 20'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
# 右回りに回転(90 deg)
...
def ccw():
    try:
        sent = sock.sendto('ccw 90'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
# 高速モード(速度40cm/sec)
...
def speed40():
    try:
        sent = sock.sendto('speed 40'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
# 低速モード(速度20cm/sec)
...
def speed20():
    try:
        sent = sock.sendto('speed 20'.encode(
            encoding="utf-8"), TELLO_ADDRESS)
    except:
        pass
